    ...
    def _thread(self, args):
        ...
        if not self.WEATHER_API_KEY:
            self._text_to_speech(
                "You need to visit world weather online to register for a free API key")
            return
        ...
        url = self.WEATHER_API.format(location.replace(' ', '+'),
        ...
        try:
            ...
            weather_description = \
            object['data']['current_condition'][0]['weatherDesc'][0][
                'value'].strip().lower()
        except:
        ...
        weather_report = 'The weather in {} is {}.'.format(location,
                                                           weather_description)
